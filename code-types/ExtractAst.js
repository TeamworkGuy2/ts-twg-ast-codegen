...
(function (ExtractAst) {
    ...
    */
    function extractInheritedTypes(childTypes, allTypeDefs, transformTypeName) {
        var typesUsed = {};
     ...
     * @returns a map of type usages found
     */
    function extractAllTypes(childTypes, allTypeDefs, includePrimitiveTypes, transformTypeName, includeInheritedTypes, includeFieldTypes, includeMethodTypes) {
    ...
    function extractTypesRecursive(classDef, typeDefs, includeInheritedTypes, includeFieldTypes, includeMethodTypes, includePrimitiveTypes, typesDst, transformTypeName) {
        if (classDef == null) {
            return typesDst;
        }
     ...
     */
    function extractAnnotationArgumentTypes(childTypes, typeDefs, includePrimitiveTypes, transformAnnotationArgument) {
        var typesUsed = {};
