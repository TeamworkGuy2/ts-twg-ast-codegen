...
suite("StringCase", function StringCaseTest() {
    test("isCamelCase()", function isCamelCase() {
        camelCase.forEach(function (str) { return asr.isTrue(StringCase.isCamelCase(str)); });
        camelCaseNum.forEach(function (str) { return asr.isTrue(StringCase.isCamelCase(str)); });
    });
    test("isTitleCase()", function isTitleCase() {
        titleCase.forEach(function (str) { return asr.isTrue(StringCase.isTitleCase(str)); });
        titleCaseNum.forEach(function (str) { return asr.isTrue(StringCase.isTitleCase(str)); });
    });
    test("isUnderscoreCase()", function isUnderscoreCase() {
        underscoreCase.forEach(function (str) { return asr.isTrue(StringCase.isUnderscoreCase(str)); });
        underscoreCaseNum.forEach(function (str) { return asr.isTrue(StringCase.isUnderscoreCase(str)); });
    });
